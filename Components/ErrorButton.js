...
const ErrorButton = ({onPress, message, style, color, bgcolor, borderRadius}) => {
  return (
    <SafeAreaView style={style}>
    <View style={{height:height/20, width:width*0.9, backgroundColor:bgcolor ?bgcolor : "blue", paddingTop:10,alignSelf:"center", borderRadius:borderRadius}}>
